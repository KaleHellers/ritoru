...
void admin() {
	...
	cout << "\t\t****************Меню********************" << endl;
	cout << "\t\t*                                      *" << endl;
	cout << "\t\t*   [Нажмите 1] Загрузить регламент    *" << endl;
	cout << "\t\t*   [Нажмите 2] Заблокировать          *" << endl;
	cout << "\t\t*               пользователя           *" << endl;
	cout << "\t\t*   [Нажмите 3] Разблокировать         *" << endl;
	cout << "\t\t*               пользователя           *" << endl;
	cout << "\t\t*   [Нажмите 4] Узнать количество      *" << endl;
	cout << "\t\t*               участников             *" << endl;
	cout << "\t\t*   [Нажмите 5] Найти участника        *" << endl;
	cout << "\t\t*   [Нажмите 6] Добавить информацию    *" << endl;
	cout << "\t\t*   [Нажмите 7] Получить список        *" << endl;
	cout << "\t\t*   [Нажмите 8] Выйти                  *" << endl;
	cout << "\t\t*                                      *" << endl;
	cout << "\t\t****************************************" << endl;
	cout << "\n\t\tВаш выбор: ";
...
void load_reglament() {
	...
	ofstream out("reglament.txt");
	cout << "Введите новый регламент(введите end чтобы закончить): " << endl;
	while (line != "end") {
		getline(cin, line);
